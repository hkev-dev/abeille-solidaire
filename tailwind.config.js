...
module.exports = {
  ...
  plugins: [
    require("./assets/core/plugins/plugin"),
    require("./assets/core/plugins/components/theme"),
    require("./assets/core/plugins/components/breakpoints"),
    require("./assets/core/plugins/components/typography"),
    require("./assets/core/plugins/components/menu"),
    require("./assets/core/plugins/components/dropdown"),
    require("./assets/core/plugins/components/accordion"),
    require("./assets/core/plugins/components/input"),
    require("./assets/core/plugins/components/input-group"),
    require("./assets/core/plugins/components/select"),
    require("./assets/core/plugins/components/textarea"),
    require("./assets/core/plugins/components/file-input"),
    require("./assets/core/plugins/components/switch"),
    require("./assets/core/plugins/components/checkbox"),
    require("./assets/core/plugins/components/radio"),
    require("./assets/core/plugins/components/range"),
    require("./assets/core/plugins/components/container"),
    require("./assets/core/plugins/components/image-input"),
    require("./assets/core/plugins/components/modal"),
    require("./assets/core/plugins/components/drawer"),
    require("./assets/core/plugins/components/tooltip"),
    require("./assets/core/plugins/components/popover"),
    require("./assets/core/plugins/components/btn"),
    require("./assets/core/plugins/components/btn-group"),
    require("./assets/core/plugins/components/tabs"),
    require("./assets/core/plugins/components/pagination"),
    require("./assets/core/plugins/components/card"),
    require("./assets/core/plugins/components/table"),
    require("./assets/core/plugins/components/badge"),
    require("./assets/core/plugins/components/rating"),
